...
const Products = () => {
  ...
  const display_products = () => {
    ...
    axios
      ...
      .catch((error) =>
        console.error("Erreur de la requète HTTPS GET " + error),
      );
  };
                ...
                <div className="card-body">
                  ...
                  <div>
                    <p className="text-success">
                      Prix : <b>{product.product_price} €</b>
                    </p>
                  </div>
                  <button
                    type="button"
                    className="btn btn-info"
                    onClick={() => display_one_product(product)}
                  >
                    Détails du produit
                  </button>
                  <button
                  ...
                  <button
                    className="btn btn-warning mx3"
                    onClick={() => switch_edit_mode(product)}
                  >
                    Editer
                  </button>
                </div>
          ...
          <div className="col-md-4 col-sm-12">
            ...
            {editProduct ? (
              <UpdateProduct
                ...
                onProductUpdated={handle_product_added}
              />
            ) : (
